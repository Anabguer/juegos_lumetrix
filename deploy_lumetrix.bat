...
echo ========================================
echo     DEPLOY LUMETRIX con WinSCP
echo ========================================
echo.
...
if "%ERR%"=="0" (
  ...
  echo ========================================
  echo.
  echo 🌐 Comprueba el juego en:
  echo   https://colisan.com/sistema_apps_upload/app_lumetrix.html
  echo.
  echo 🔌 Verifica la API:
  echo   https://colisan.com/sistema_apps_upload/sistema_apps_api/lumetrix/test_db.php
  echo   https://colisan.com/sistema_apps_upload/sistema_apps_api/lumetrix/auth.php?action=check_session
  echo.
  echo 📊 Health check general:
  echo   https://colisan.com/__ping.php
  echo.
