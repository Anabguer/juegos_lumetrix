      ...
      <div className="introWrap">
        ...
        <div className="panel">
          ...
          <div className="actions">
            ...
            <button className="btn btn2" onClick={onAuth}>Registrarse</button>
          </div>
        </div>
...
function Auth({ onClose }){
  return (
    <div className="modal"><div className="card" style={{maxWidth:'420px'}}>
      <button className="closer" onClick={onClose}>✕</button>
      <h3 style={{ color: 'var(--neon2)', marginTop:0, marginBottom:12 }}>Registrarse</h3>
      <div className="list" style={{gap:12}}>
        <input placeholder="Nick" style={{ background:'#000', border:'1px solid #ffffff33', borderRadius:10, padding:10, color:'#fff' }} />
        <input placeholder="Nombre" style={{ background:'#000', border:'1px solid #ffffff33', borderRadius:10, padding:10, color:'#fff' }} />
        <input placeholder="Correo" type="email" style={{ background:'#000', border:'1px solid #ffffff33', borderRadius:10, padding:10, color:'#fff' }} />
        <input placeholder="Contraseña" type="password" style={{ background:'#000', border:'1px solid #ffffff33', borderRadius:10, padding:10, color:'#fff' }} />
